<?php
    ...
    try{
        ...
        $sql = 'SELECT events_name, events_description, events_presenter FROM wdv341_events WHERE events_id (events_name,events_description, events_presenter) VALUES 
        ...
        echo "still working";
        $eventRecord = $stmt->fetchAll(PDO::FETCH_ASSOC);
