...
<p>Thank you for your interest in <?php echo $_POST['school_name']; ?></p>

<p>We have you listed as a <?php echo $_POST['academicStanding']?> student starting this fall. </p>
...
<div><?php echo $_POST['info1'] ?></div>
<div><?php echo $_POST['info2'] ?></div>

<p>You have shared the following comments which we will review: <?php echo $_POST['comment'] ?> </p>
...
<!-- <p>You are registered as: <?php echo "$last_name, $first_name" ?> </p>

<p>We have sent a confirmation email to you at: <?php echo $_POST["email_address"]; ?></p> -->
